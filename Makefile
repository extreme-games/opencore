...
SOURCEFILES = opencore.cpp botman.cpp cmd.cpp cmdexec.cpp config.cpp encrypt.cpp lib.cpp log.cpp msg.cpp ops.cpp parsers.cpp phand.cpp player.cpp pkt.cpp psend.cpp util.cpp
